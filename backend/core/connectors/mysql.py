"""MySQL connector: import a table or view over a pasted connection URL."""
...
PROVIDER = "mysql"
SCHEMES = {"mysql": "mysql+pymysql", "mariadb": "mysql+pymysql", "mysql+pymysql": "mysql+pymysql"}
HIDDEN_SCHEMAS = frozenset({"information_schema", "performance_schema", "mysql", "sys"})
