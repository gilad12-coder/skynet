 ...
 * default ("Auto") row first and a checkmark on the active row. The choice
 * applies from the next turn of the surrounding conversation.
 *
 ...
 * ModelPicker.
 */
export function ComposerModelMenu({ value, onChange, disabled }: ComposerModelMenuProps) {
            ...
            <div key={provider}>
              ...
              {group.map((m) => (
                <MenuRow
                  ...
                  label={m.label}
                  description={m.value === m.label ? undefined : m.value}
