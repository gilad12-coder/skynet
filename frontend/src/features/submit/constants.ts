...
// MCP server. An explicit array is the exact allow-list; null preserves the
// legacy "full live roster" contract; undefined means a fresh endpoint has not
// returned its first roster yet.
