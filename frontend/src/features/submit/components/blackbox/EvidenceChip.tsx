...
import { CheckCircle, Warning } from "@/shared/ui/icons";
 ...
 * rather than as a failure. Before any check has run, and while one runs
 * (the validation frame reports that), there is nothing to say here, so
 * the chip stays out of the way.
 */
